      ...
      resources: [
        {
          ...
          device: {
            geolocation: {},
            userAgent: "MKTSRV/606b1062840c9d1aabdcd9ca"
          },
          receivers: [
            {
              moipAccount: {
        ...
        },
        {
          ...
          device: {
            geolocation: {},
            userAgent: "MKTSRV/606b6d08ff061a6af6fd865e"
          },
          receivers: [
            {
              moipAccount: {
        ...
        },
        {
          ...
          device: {
            geolocation: {},
            userAgent: "MKTSRV/606b797da8665808ee3ef3de"
          },
          receivers: [
            {
              moipAccount: {
        ...
        },
        {
          ...
          device: {
            geolocation: {},
            userAgent: "MKTSRV/606b7c61a8665808ee3ef3e9"
          },
          receivers: [
            {
              moipAccount: {
        ...
        },
        {
          ...
          device: {
            geolocation: {},
            userAgent: "MKTSRV/606df2d3c7c8d73506bffbdb"
          },
          receivers: [
            {
              moipAccount: {
